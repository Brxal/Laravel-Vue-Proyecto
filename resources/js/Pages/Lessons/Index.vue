                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="p-6 bg-white border-b border-gray-200"> 
                        <div class="flex justify-between" v-if="$page.props.user.permissions.includes('create lessons') ">
                            <Link :href="route('lessons.create')" class="text-white bg-green-500 hover:bg-green700 py-2 px-4 rounded" v-if="$page.props.user.permissions.includes('create lessons')">
                                CREATE LESSON
                        ...
                        <div class="flex justify-between mt-2">
                            <Link v-if="lessons.current_page > 1" :href="lessons.prev_page_url" class="text-white bg-green-500 hover:bg-rose-700 py-2 px-4 rounded">        
                                PREV
                            </Link>
                            <div v-else></div>
                            <Link v-if="lessons.current_page < lessons.last_page" :href="lessons.next_page_url" class="text-white bg-green-500 hover:bg-rose-700 py-2 px-4 rounded">
                                NEXT
                            </Link>
                            <div v-else></div>
                        </div>
