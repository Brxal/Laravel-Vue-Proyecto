                ...
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="p-6 bg-white border-b border-gray-200"> 
                        <div class="flex justify-between" v-if="$page.props.user.permissions.includes('create categories') ">
                            <Link :href="route('categories.create')" class="text-white bg-green-500 hover:bg-green700 py-2 px-4 rounded" v-if="$page.props.user.permissions.includes('create categories')">
                                CREATE CATEGORY 
                        ...
                        <div class="flex justify-between mt-2">
                            <Link v-if="categories.current_page > 1" :href="categories.prev_page_url" class="text-white bg-green-500 hover:bg-rose-700 py-2 px-4 rounded">        
                                PREV
                            </Link>
                            <div v-else></div>
                            <Link v-if="categories.current_page < categories.last_page" :href="categories.next_page_url" class="text-white bg-green-500 hover:bg-rose-700 py-2 px-4 rounded">
                                NEXT
                            </Link>
                            <div v-else></div>
                        </div>
